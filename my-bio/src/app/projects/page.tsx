        ...
        <div className='bg-gradient-to-bl from-teal-400 to-amber-500 min-h-screen text-black'>
            <section className="text-gray-600 body-font">
                <div className="container px-5 py-24 mx-auto">
                    ...
                    <div className="mt-20 flex flex-wrap -m-4">
                        <div className="p-4 md:w-1/2 w-full">
                            <div className="h-full bg-black border-fuchsia-600 border-4 p-8 rounded">
                                <svg
                                ...
                                <p className=" flex-auto text-center leading-relaxed mb-6 text-amber-400 text-6xl hover:text-green-400 ">
                                    COMING SOON
                                </p>
                                <a className="inline-flex items-center">
                                    <div className="flex lg:max-w-lg lg:w-full md:w-1/2 w-5/6 mb-10 md:mb-0">
                                        ...
                                        <span className="flex-grow flex flex-col pl-4">
                                            ...
                                            <span className="text-gray-500 text-2xl ml-40">In process Yet</span>
                                        </span>
                                    </div>
                                </a>
                            </div>
